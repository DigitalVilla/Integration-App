...
DBMS_OUTPUT.PUT_LINE(p_location||' '||p_filename||' '||k_write_access_mode);    
v_file_type :=  UTL_FILE.FOPEN(p_location, p_filename, k_write_access_mode);
